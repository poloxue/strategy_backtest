...
class DCAStrategy(bt.Strategy):
    ...
    def __init__(self):
        ...
        self.short_ema = bt.indicators.EMA(self.data.close, period=10)  # pyright: ignore
        self.long_ema = bt.indicators.EMA(self.data.close, period=20)  # pyright: ignore
        self.bear_count = 0
